import { Package, Search, Calendar, Hash, IndianRupee, Loader2 } from "lucide-react";
...
const MechanicParts = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm relative">
      {/* Header section */}
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Aggregated parts available for your jobs.</p>
            </div>
          </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4 py-4 border-t border-slate-50">
                    ...
                    <div className="text-right">
                      <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1">Avg Unit Price</p>
