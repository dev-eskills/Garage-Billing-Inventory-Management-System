  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 sm:p-6">
      ...
      <motion.div
        ...
        className="relative bg-white w-full max-w-xl rounded-md shadow-2xl overflow-hidden"
      >
        {/* Header */}
        <div className="bg-[#2b5ae3] px-6 py-8 text-white relative">
          ...
          <h4 className="text-2xl font-bold tracking-tight text-center">{isEdit ? 'Update Mechanic Details' : 'Register New Mechanic'}</h4>
          <p className="text-blue-100 font-medium mt-1 text-center text-sm">{isEdit ? 'Modify team member profile information.' : 'Create a secure account for your team member.'}</p>
        </div>
