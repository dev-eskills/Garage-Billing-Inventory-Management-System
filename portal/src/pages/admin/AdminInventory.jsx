    ...
    const TabButton = ({ id, label, icon: Icon }) => (
        <button
            ...
            className={`flex items-center gap-2 pb-3 px-1 text-sm font-bold transition-all relative ${
                activeTab === id ? 'text-[#2b5ae3]' : 'text-gray-500 hover:text-gray-700'
            }`}
        >
            <Icon size={16} />
            {label}
                                                ...
                                                <tr key={part.id} className="hover:bg-gray-50/50 transition-colors group">
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-10 h-10 rounded-md bg-blue-50 flex items-center justify-center text-[#2b5ae3]">
                                                                <Package size={18} />
                                                            </div>
                                                            <div>
                                        ...
                                        {currentData.length === 0 ? (
                                            ...
                                            currentData.map((item) => (
                                                <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-2">
                                                            <div className="p-1.5 bg-blue-50 text-[#2b5ae3] rounded border border-blue-100">
                                                                <Package size={14} />
                                                            </div>
                                                            <div>
                                        ...
                                        {currentData.length === 0 ? (
                                            ...
                                            currentData.map((item) => (
                                                <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-2">
                                                            <div className="p-1.5 bg-orange-50 text-orange-600 rounded border border-orange-100">
                                                                <Package size={14} />
                                                            </div>
                                                            <div>
                                                                <p className="font-bold text-gray-900 text-sm">{item.parts?.part_name}</p>
