    ...
    >
      ...
      <div className="contact-container">
        ...
        >
          ...
          >
            <Heart size={14} style={{ marginRight: 6 }} /> Indore Ka Bharosa
          </div>
          <h1
            style={{
          ...
          >
            Aaiye, <span style={{ color: "var(--accent-red)" }}>Milkar</span>{" "}
            Baat Karein.
          </h1>
          <p
            style={{
          ...
          >
            Indore ka sabse trusted garage ab bas ek call ki doori par. Koi bhi
            sawal ho, humse connect karein.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            >
              <div className="contact-item">
                ...
                <h3
                  style={{ fontSize: "1.1rem", fontWeight: 800, color: "#111" }}
                >
                  Humara Pata
                </h3>
                <p
                  style={{ color: "#666", lineHeight: 1.5, fontSize: "0.9rem" }}
                >
                  Moin Motors Hub, <br />
                  Khudel, Indore, MP (452016)
                </p>
              </div>
            </a>
          ...
          >
            ...
            >
              <MessageCircle size={18} /> WhatsApp Par Baat Karein
            </a>
          </div>
